...
public class CrudService {
    ...
    @RequestMapping(path = "/barleyrs/entities/{namespace}/{entityType}/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    public Entity getEntityById(
            @PathVariable("namespace") String namespace,
            @PathVariable("entityType") String entityTypeName,
            @PathVariable("id") String id,
            @RequestParam("proj") String projecting) throws BarleyDBException {
    ...
    public QueryResult<Object> listEntities(
            @PathVariable("namespace") String namespace,
            @PathVariable("entityType") String entityTypeName,
            @RequestParam(value = "proj", required = false) String projecting) throws BarleyDBException {
    ...
    @GetMapping(path = "/barleyrs/tables/{namespace}/{entityType}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/barleyrs/entities/{namespace}/{entityType}",
